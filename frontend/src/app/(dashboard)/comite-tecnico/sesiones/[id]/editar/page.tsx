...
export default async function EditarSesionComiteTecnicoPage({ params }: PageProps) {
  ...
  if (!microciclos) {
    redirect(COMITE_TECNICO_ROUTES.sesiones.list);
  }
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="sm" asChild>
          <Link href={COMITE_TECNICO_ROUTES.sesiones.detalle(id)}>
