...
import { fetchSesion, deleteSesion } from '@/features/comite-tecnico/actions';
...
export default async function SesionDetalleComiteTecnicoPage({ params }: PageProps) {
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button asChild>
            <Link href={COMITE_TECNICO_ROUTES.sesiones.editar(id)}>
