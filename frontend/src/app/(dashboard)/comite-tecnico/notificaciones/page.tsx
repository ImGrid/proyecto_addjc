...
export default async function NotificacionesCTPage({ searchParams }: PageProps) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {total} notificacion{total !== 1 ? 'es' : ''} - Notificaciones del sistema y alertas del algoritmo
          </p>
        </div>
      </div>
