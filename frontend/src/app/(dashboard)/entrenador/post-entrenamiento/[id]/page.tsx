...
import { fetchRegistroEntrenador } from '@/features/entrenador/actions/fetch-registros';
...
export default async function RegistroDetallePage({ params }: PageProps) {
  const { id } = await params;
  const registro = await fetchRegistroEntrenador(id);
