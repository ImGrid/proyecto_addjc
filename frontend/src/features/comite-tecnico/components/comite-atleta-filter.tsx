...
interface ComiteAtletaFilterProps {
  atletas: AtletaOption[];
}

// Filtros para la pagina de post-entrenamiento del comite tecnico
// Soporta: atleta, fecha desde/hasta, asistencia, RPE minimo
export function ComiteAtletaFilter({ atletas }: ComiteAtletaFilterProps) {
