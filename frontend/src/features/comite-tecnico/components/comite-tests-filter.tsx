...
interface ComiteTestsFilterProps {
  atletas: AtletaOption[];
  microciclos: MicrocicloOption[];
}

// Filtros para la pagina de tests fisicos del comite tecnico
// Soporta: atleta, microciclo, fecha desde/hasta, asistencia
export function ComiteTestsFilter({ atletas, microciclos }: ComiteTestsFilterProps) {
