...
export async function createSesion(
  ...
  try {
    ...
    const rawData = {
      ...
      fcObjetivo: formData.get('fcObjetivo') || undefined,
      relacionVI: formData.get('relacionVI'),
      zonaEsfuerzo: formData.get('zonaEsfuerzo') || undefined,
      duracionReal: formData.get('duracionReal') || undefined,
